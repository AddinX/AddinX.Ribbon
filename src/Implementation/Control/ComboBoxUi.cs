...
{
    public class ComboBoxUi : ControlUi, IComboBoxUi
    {
        ...
        protected internal IComboBoxIdUi SetLabel(string value)
        {
            Label = value;
            return this;
        }
        ...
        public IComboBoxExtra AddItems(Action<IItemsUi> items)
        {
