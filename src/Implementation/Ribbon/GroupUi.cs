...
{
    public class GroupUi : AddInElement, IGroupUi
    {
        private IElementId id;
        private readonly IGroupControlsUi controls;
        ...
        protected internal GroupUi SetLabel(string value)
        {
            label = value;
            return this;
        }

        public IGroupExtra Items(Action<IGroupControlsUi> value)
        {
